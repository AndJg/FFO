$(function(){
    $(document).on('click', '.like-btn', function(){
        ...
        $.post('http://localhost/ffo/core/ajax/like.php', {like:rcmd_id, user_id:user_id,}, function(){
        counter.show();
    ...
    $(document).on('click', '.unlike-btn', function(){
        ...
        $.post('http://localhost/ffo/core/ajax/like.php', {unlike:rcmd_id, user_id:user_id,}, function(){
        counter.show();
