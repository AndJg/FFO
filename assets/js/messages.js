...
$(document).on('click', '#messagePopup', function(){
    ...
    $.post('http://localhost/ffo/core/ajax/messages.php', {showMessage:getMessages}, function(data){
    ...
    $(document).on('click', '.people-message', function(){
        ...
        $.post('http://localhost/ffo/core/ajax/messages.php',{showChatPopup:get_id}, function(data){
        ...
        $.post('http://localhost/ffo/core/ajax/messages.php',{showChatMessage:get_id}, function(data){
        ...
        $(document).on('click', '.back-messages', function(){
           ...
           $(document).on('click', '.deleteMsg', function(){
            ...
            $(document).on('click', '.delete', function(){
             $.post('http://localhost/ffo/core/ajax/messages.php', {deleteMsg:messageID}, function(data){
